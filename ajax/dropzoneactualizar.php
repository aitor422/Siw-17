...
if(isset($_FILES["file"])){
   ...
   $consulta="INSERT INTO final_imagenes (idproducto, imagen) VALUES ($idproducto, '$g')";
   if ($con->query($consulta) != TRUE){
      echo "NO FUNCIONA->Error al añadir Imagenes";
		die();
   }
   $consulta="INSERT INTO final_imagenes (idproducto, imagen) VALUES ($idproducto, '$m')";
   if ($con->query($consulta) != TRUE){
      echo "NO FUNCIONA->Error al añadir Imagenes";
		die();
   }
   $consulta="INSERT INTO final_imagenes (idproducto, imagen) VALUES ($idproducto, '$p')";
   if ($con->query($consulta) != TRUE){
      echo "NO FUNCIONA->Error al añadir Imagenes";
		die();
   }
